...
// Needs allocator param since init_values() uses it with temp_allocator.
// Also it allows for trivial freeing in local arena allocators.
// The caller has to handle the returned string

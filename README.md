...
| Data.bb         | Sep 16, 2025      | 5/10     | 774          |
| Functions.bb    | Sep 16, 2025      | 8/10     | 289          |
...
### Blitz3D API status
Only Placeholder functions without implementations.
Check the Todo.txt file for the API functions that Hard Time uses.
